...
(function (global, factory) {
  ...
  var SELECTOR_CARD_HEADER = '.card-header.blade.php';
  ...
  var SELECTOR_HEADER$1 = '.main-header.blade.php';
  ...
  var SELECTOR_HEADER_MENU_ITEM = '.main-header.blade.php .nav-item a.nav-link';
  var SELECTOR_HEADER_DROPDOWN_ITEM = '.main-header.blade.php a.dropdown-item';
  ...
  var SELECTOR_HEADER = '.main-header.blade.php';
  ...
  var CLASS_NAME_HEADER = 'nav-header.blade.php';
  ...
  var Toasts = /*#__PURE__*/function () {
    ...
    _proto.create = function create() {
      ...
      var toastHeader = $__default["default"]('<div class="toast-header.blade.php">');
