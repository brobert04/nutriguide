...
(function ($) {
  ...
  var $dropdown_legacy_offset_checkbox = $('<input />', {
    type: 'checkbox',
    value: 1,
    checked: $('.main-header.blade.php').hasClass('dropdown-legacy'),
    class: 'mr-1'
  }).on('click', function () {
    if ($(this).is(':checked')) {
      $('.main-header.blade.php').addClass('dropdown-legacy')
    } else {
      $('.main-header.blade.php').removeClass('dropdown-legacy')
    }
  })
  ...
  var $no_border_checkbox = $('<input />', {
    type: 'checkbox',
    value: 1,
    checked: $('.main-header.blade.php').hasClass('border-bottom-0'),
    class: 'mr-1'
  }).on('click', function () {
    if ($(this).is(':checked')) {
      $('.main-header.blade.php').addClass('border-bottom-0')
    } else {
      $('.main-header.blade.php').removeClass('border-bottom-0')
    }
  })
  ...
  var $text_sm_header_checkbox = $('<input />', {
    type: 'checkbox',
    value: 1,
    checked: $('.main-header.blade.php').hasClass('text-sm'),
    class: 'mr-1'
  }).on('click', function () {
    if ($(this).is(':checked')) {
      $('.main-header.blade.php').addClass('text-sm')
    } else {
      $('.main-header.blade.php').removeClass('text-sm')
    }
  })
  ...
  var $navbar_variants_colors = createSkinBlock(navbar_all_colors, function () {
    ...
    var $main_header = $('.main-header.blade.php')
  ...
  $('.main-header.blade.php')[0].classList.forEach(function (className) {
